...
class EmployeRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    public function __construct(ManagerRegistry $registry)
    {
     ...
     public function upgradePassword(PasswordAuthenticatedUserInterface $employe, string $newHashedPassword): void
    {
        if (!$employe instanceof Employe) {
            throw new UnsupportedUserException(sprintf('Instances of "%s" are not supported.', $employe::class));
        }
